                    ...
                    <div class="col-md-10">
                        <div class="container">
                            <div class="row">
                                ...
                                padding-top:3%;">
                                    <span><b>STUDENT'S REGISTRATION FORM</b> </span>
                                </div>

                                <div class="col-md-12">
                                    <form action="registerstd">
                                        <div class="cont01" style="background-color: white;">

                                            <div class="title">
                                                Please!, Honestly fill the student's valid details.
                                            </div>
                                            ...
                                            <div style="padding-left:55%; padding-top: 5%;">
                                                <div class="col-sm-3" style="color: black;font-weight: 900;">
